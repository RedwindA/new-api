...
func TestProcessChannelErrorUsesSnapshotWithoutLeakingChannelMetadata(t *testing.T) {
	...
	require.NoError(t, database.Create(&model.User{Id: 7, Username: "log-owner", Password: "password12", Group: "default"}).Error)
	...
	processChannelError(ctx, channelSnapshot, apiErr)
