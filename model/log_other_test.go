...
func TestLogOtherAllowsStreamStatusAsPublicWrite(t *testing.T) {
	other := NewLogOther()
	require.True(t, other.SetPublic("stream_status", map[string]any{"status": "error"}))
	require.Contains(t, other.Snapshot(), "stream_status")
}
