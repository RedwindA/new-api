...
// userHiddenLogOtherKeys are stripped from user-visible projections. This
// includes the historical channel/reject-reason leak plus stream_status,
// which is stored as a public top-level field but hidden from non-admin
// viewers on this branch.
var userHiddenLogOtherKeys = append(slices.Clone(legacySensitiveLogOtherKeys), "stream_status")
